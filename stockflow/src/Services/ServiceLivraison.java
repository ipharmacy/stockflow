...
public  class ServiceLivraison implements IServiceLivraison<Livraison> {
    ...
    public void updateLivraison(Livraison l) throws SQLException {
        ...
        pre.setDate(1, new java.sql.Date(l.getDatelivraison().getTime()));
         pre.setTime(2, new java.sql.Time(l.getTimelivraison().getTime()));
      ...
      System.out.println("hello update "+l.getIdlivraison());
         pre.executeUpdate();
    }
   ...
   while (rs.next()) {                
    ...
    System.out.println(arr);  
     ...
     try{
      ...
      Paragraph p1=new Paragraph(null,f2);
     p1.add("HISTORIQUE DES COMMANDES ");
p1.setAlignment(Element.ALIGN_CENTER);
      
            document.add(Image.getInstance("C:\\Users\\Dhia\\Desktop\\pii\\Final_Project\\Stockflow\\src\\images\\stocklogo.png"));  
